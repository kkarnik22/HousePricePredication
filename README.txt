...
Here two csv files are used:
•	train.csv
•	test.csv
The train.csv file contains all the attributes/columns of the houses including the saleprice. We first train the model according to data present in train.csv file and also present that data graphically.
The test.csv file contains all attributes of house excluding the saleprice. After training the model we provide it the values of attributes and the saleprice is predicted based on those values.
...
This file gives you the detailed information about the project.

File descriptions:

•	train.csv - the training set
•	test.csv - the test set
•	README.txt - full description of each column
...
•	2FmCon		Two-family Conversion; originally built as 1 family dwelling
•	Duplx		Duplex
...
•	TA	Average - Prefabricated Fireplace in main living area or Fireplace in basement
